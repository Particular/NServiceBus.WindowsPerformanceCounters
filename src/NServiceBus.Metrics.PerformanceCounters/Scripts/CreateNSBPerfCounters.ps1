...
$counters.AddRange(@(
	...
	New-Object System.Diagnostics.CounterCreationData "Critical Time AverageBase", "The time it took from sending to processing the message. Useful to understand how long a new message added to the queue right now will take to be processed.",  AverageBase
	New-Object System.Diagnostics.CounterCreationData "Critical Time", "Duration in rounded seconds for sending and processing the last processed message, useful to understand how long a new message added to the queue right now will take to be processed. This is an instantaneous snapshot, not an average over the time interval.",  NumberOfItems32
	...
	New-Object System.Diagnostics.CounterCreationData "Processing Time", "Duration in rounded seconds of the last successfully processed message. This is an instantaneous snapshot, not an average over the time interval.",  NumberOfItems32
