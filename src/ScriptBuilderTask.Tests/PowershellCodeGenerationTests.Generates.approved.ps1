...
Function InstallNSBPerfCounters {
    ...
    $counters.AddRange(@(
        ...
        New-Object System.Diagnostics.CounterCreationData "Avg. Critical Time", "The time it took from sending to processing the message.",  AverageTimer32
       New-Object System.Diagnostics.CounterCreationData "Avg. Critical TimeBase", "The time it took from sending to processing the message.",  AverageBase
        ...
        New-Object System.Diagnostics.CounterCreationData "Avg. Processing Time", "The time it took to successfully process a message.",  AverageTimer32
       New-Object System.Diagnostics.CounterCreationData "Avg. Processing TimeBase", "The time it took to successfully process a message.",  AverageBase
